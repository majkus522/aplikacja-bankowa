...
template <> constexpr inline auto Register::qt_create_metaobjectdata<qt_meta_tag_ZN8RegisterE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_btnRegisterSubmit_clicked",
        "on_btnCancelRegister_clicked"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_btnRegisterSubmit_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnCancelRegister_clicked'
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_btnRegisterSubmit_clicked(); break;
        case 3: _t->on_btnCancelRegister_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Register::*)()>(_a, &Register::cancelRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Register::*)()>(_a, &Register::registrationSuccessful, 1))
            return;
    }
}
...
// SIGNAL 0
void Register::cancelRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Register::registrationSuccessful()
{

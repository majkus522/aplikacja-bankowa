...
TransferDialog::TransferDialog(int senderAccountId, double maxBalance, QWidget *parent) : QDialog(parent), ui(new Ui::TransferDialog), m_senderAccountId(senderAccountId), m_maxBalance(maxBalance)
{
    ui->setupUi(this);
...
void TransferDialog::on_btnConfirm_clicked()
{
    ...
    QSqlQuery logQuery;
    logQuery.prepare("INSERT INTO transactions (sender_account_id, receiver_account_id, amount, title) VALUES (:sender, :receiver, :amount, :title)");
